function error_ = readPLX_plxFile_v20090508(filename)
% function error_ = readPLX_plxFile_v20090508(filename)
%
...
%
% Long Ding 2014-03-16, does not work under R2011b 64-bit
...
[OpenedFileName, version, freq, comment, Trodalness, NPW, PreThresh, SpikePeakV, SpikeADResBits, SlowPeakV, SlowADResBits, Duration, DateTime] = plx_information(fname);
