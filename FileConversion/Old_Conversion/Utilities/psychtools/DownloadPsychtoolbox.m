function DownloadPsychtoolbox(flavor, tree, targetdirectory)
% function DownloadPsychtoolbox(flavor, tree, targetdirectory)
%
% revised by jig 12/6/05 to get source tree
%
...
if nargin < 3 || isempty(targetdirectory)
    targetdirectory = '/Users/jigold/GoldWorks/Mirror_lab/Matlab/mex_lab/Psychtoolbox_latest';
end;
...
checkoutcommand = char([ '/usr/local/bin/svn checkout svn://svn.berlios.de/osxptb/' flavor '/' tree '/ ' targetdirectory '/' flavor '/' tree]);
